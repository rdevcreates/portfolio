...
export default function HomeSection() {
  ...
  useEffect(() => {
    ...
    timerRef.current = setTimeout(updateText, 100);
    return () => {
      if (timerRef.current) clearTimeout(timerRef.current);
    };
  }, [displayText, isDeleting, loopIndex, texts]);

  const socialLinks = [
    // Uncomment kalau mau tampil LinkedIn dan Email
    // {
    //   href: 'https://www.linkedin.com/in/rudiyat-rudiyat-2a9490339',
    //   icon: Linkedin,
    //   label: 'LinkedIn',
    // },
    {
      href: 'https://www.instagram.com/olahdata_kuesionaer',
      icon: Instagram,
      label: 'Instagram',
    },
    // {
    ...
    // },
    {
      href: 'https://github.com/rdevcreates',
      icon: Github,
      label: 'GitHub',
    },
  ];
